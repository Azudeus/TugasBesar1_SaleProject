function like(element){
	...
	if (element.innerHTML =='like'){
		...
		xhttp.open("GET", "like.php?user_id="+user_id+"&product_id="+product_id+"&operation=add",true);
		xhttp.send();
		...
		var count = parseInt(document.getElementsByClassName(p_id)[0].innerHTML) - 1;
		document.getElementsByClassName(p_id)[0].innerHTML = count + " likes";
		xhttp.open("GET", "like.php?user_id="+user_id+"&product_id="+product_id+"&operation=min",true)
		xhttp.send();
	}
}